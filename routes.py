...
_routes = [
    ...
    RedirectRoute('/bom/<public_id>', handlers.BomBuildViewHandler, name='bom_build', strict_slash=True),
    RedirectRoute('/bom/<public_id>/order', handlers.BomOrderViewHandler, name='bom_order', strict_slash=True),
